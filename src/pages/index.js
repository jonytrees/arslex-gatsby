      ...
      <div className="box">
                <div className="toptext-wrapper">
                    ...
                    <div className="header-wrapper">
                        <div className="header">
                            ...
                            <ul className="topmenu">
                                <li className="goto"><span className="link1">Home</span></li>
                                <li className="goto"><span className="link2">About</span></li>
                                <li className="goto"><span className="link3">Services</span></li>
                                <li className="goto"><span className="sendpage">Contact</span></li>
                            </ul>
                        </div>
                    </div>
                    <div className="toptext">
                        ...
                        <p>Legal Advisory</p>
                        <div className="toptext-button goto">
                            <p className="sendpage">Contact now</p>
                        </div>
